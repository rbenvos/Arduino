...
/* Sensores*/
int sensor_1_CS = 5;             // CS pin on MAX6675
int sensor_1_SO = 4;              // SO pin of MAX6675
int sensor_1_SCK = 6;             // SCK pin of MAX6675
float sensor_1_temperature = 0.0;  // Temperature output variable

int sensor_2_CS = 30;             // CS pin on MAX6675
int sensor_2_SO = 31;              // SO pin of MAX6675
int sensor_2_SCK = 32;             // SCK pin of MAX6675
float sensor_2_temperature = 0.0;  // Temperature output variable

int sensor_3_CS = 33;             // CS pin on MAX6675
int sensor_3_SO = 34;              // SO pin of MAX6675
int sensor_3_SCK = 35;             // SCK pin of MAX6675
float sensor_3_temperature = 0.0;  // Temperature output variable

int sensor_4_CS = 36;             // CS pin on MAX6675
int sensor_4_SO = 37;              // SO pin of MAX6675
int sensor_4_SCK = 38;             // SCK pin of MAX6675
float sensor_4_temperature = 0.0;  // Temperature output variable
...
MAX6675 temp_2(sensor_2_SCK, sensor_2_CS, sensor_2_SO);
MAX6675 temp_3(sensor_3_SCK, sensor_3_CS, sensor_3_SO);
MAX6675 temp_4(sensor_4_SCK, sensor_4_CS, sensor_4_SO);
